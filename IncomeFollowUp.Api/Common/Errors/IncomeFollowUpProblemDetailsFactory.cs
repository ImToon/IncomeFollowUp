...
using IncomeFollowUp.Application.Common.Exceptions;

namespace IncomeFollowUp.Api.Common.Errors;

public class IncomeFollowUpProblemDetailsFactory : ProblemDetailsFactory
{
    private readonly ApiBehaviorOptions _options;
    private readonly Action<ProblemDetailsContext>? _configure;

    public IncomeFollowUpProblemDetailsFactory(
